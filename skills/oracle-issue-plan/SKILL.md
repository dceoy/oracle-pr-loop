...
compatibility layers, or new infrastructure unless the issue requires them.'
```
...
abstractions, compatibility layers, or new infrastructure unless the issues require them.'
```
