...
- Pass any caller-supplied leaf-execution deadline through unchanged and otherwise rely only on a finite bound guaranteed by the runtime. The orchestrator must not invent, shorten, or override a leaf deadline.
